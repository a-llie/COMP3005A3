...
def getAllStudents():
    with conn.cursor() as cur:
        try:
            ...
            print("\nERR: An error occurred while retrieving the students.")
            conn.rollback()
...
def addStudent(first_name, last_name, email, enrollment_date):
    with conn.cursor() as cur:
        try:
            ...
            print("\nERR: An error occurred while adding the student.")
            conn.rollback()
...
def updateStudentEmail(student_id, new_email):
    with conn.cursor() as cur:
        try:
            ...
            print("\nERR: An error occurred while updating the student's email.")
            conn.rollback()   
...
def deleteStudent(student_id):
    with conn.cursor() as cur:
        try:
            ...
            print("\nERR: An error occurred while deleting the student.")
            conn.rollback()
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\nERR: An error occurred while connecting to the database.")
        exit()
